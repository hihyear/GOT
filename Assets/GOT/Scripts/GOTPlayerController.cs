...
public class GOTPlayerController : MonoBehaviour
{
    [Header("Player")]
    ...
    private void CameraRotation()
    {
        ...
        Vector3 cameraAngle = _mainCamera.transform.rotation.eulerAngles;
        ...
        _mainCamera.transform.rotation = Quaternion.Euler(x, cameraAngle.y + mouseDelta.x, cameraAngle.z);
